...
public class ConfirmLockPatternViewLogin extends View {
    ...
    public static class FirstHighlight implements HighlightMode {
        @Override // net.newsoftwares.hidepicturesvideos.securitylocks.ConfirmLockPatternViewLogin.HighlightMode
    ...
    private void buildDrawables() {
        ...
        this.mNodeDrawables = (NodeDrawable[][]) Array.newInstance(NodeDrawable.class, i, i);
        ...
        for (int i4 = 0; i4 < this.mLengthNodes; i4++) {
            for (int i5 = 0; i5 < this.mLengthNodes; i5++) {
                ...
                this.mNodeDrawables[i5][i4] = new NodeDrawable(f, new Point((i5 * i6) + i3, (i6 * i4) + i3), this.con);
            }
        }
    ...
    private void testPracticePattern() {
        ...
        this.mHandler.postDelayed(new Runnable() { // from class: net.newsoftwares.hidepicturesvideos.securitylocks.ConfirmLockPatternViewLogin.1
    ...
    public void testPattern(List<Point> list, List<Point> list2) {
        ...
        this.mHandler.postDelayed(new Runnable() { // from class: net.newsoftwares.hidepicturesvideos.securitylocks.ConfirmLockPatternViewLogin.2
            @Override // java.lang.Runnable
            public void run() {
                ConfirmLockPatternViewLogin.this.resetPractice();
                ConfirmLockPatternViewLogin.this.invalidate();
...
//                    new LoginActivity.HackAttemptLoginClass().HackAttempt(this.con);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!SecurityLocksCommon.IsStealthModeOn) {
            try {
                LoginActivity.txt_wrong_pttern.setVisibility(INVISIBLE);
