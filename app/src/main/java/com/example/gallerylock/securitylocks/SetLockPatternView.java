...
public class SetLockPatternView extends View {
    ...
    public static class FirstHighlight implements HighlightMode {
        @Override // net.newsoftwares.hidepicturesvideos.securitylocks.SetLockPatternView.HighlightMode
    ...
    private void testPracticePattern() {
        ...
        this.mHandler.postDelayed(new Runnable() { // from class: net.newsoftwares.hidepicturesvideos.securitylocks.SetLockPatternView.1
