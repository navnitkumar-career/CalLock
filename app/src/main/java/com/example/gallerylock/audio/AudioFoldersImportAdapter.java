...
public class AudioFoldersImportAdapter extends ArrayAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.imageAlbum.setBackgroundResource(R.drawable.ic_audio_list_empty_icon);
            ...
            viewHolder.checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: net.newsoftwares.hidepicturesvideos.audio.AudioFoldersImportAdapter.1
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    AudioFoldersImportAdapter.this.importAlbumEnts.get(((Integer) compoundButton.getTag()).intValue()).SetAlbumFileCheck(compoundButton.isChecked());
                }
            });
