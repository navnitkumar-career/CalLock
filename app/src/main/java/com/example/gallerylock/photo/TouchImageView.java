...
public class TouchImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void sharedConstructing(Context context) {
        ...
        setOnClickListener(new OnClickListener() { // from class: net.newsoftwares.hidepicturesvideos.photo.TouchImageView.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                float f = 0;
                TouchImageView.this.IsClick++;
                if (TouchImageView.this.IsClick == 2) {
                    TouchImageView.this.IsClick = 0;
                    TouchImageView.this.mode = 2;
                    if (TouchImageView.this.mzoomScaleFactor <= 6.0f) {
                    ...
                    if (TouchImageView.this.saveScale > TouchImageView.this.maxScale) {
                        ...
                        if (TouchImageView.this.origWidth * TouchImageView.this.saveScale > TouchImageView.this.viewWidth || TouchImageView.this.origHeight * TouchImageView.this.saveScale <= TouchImageView.this.viewHeight) {
                            TouchImageView.this.matrix.postScale(f2, f2, TouchImageView.this.viewWidth / 2, TouchImageView.this.viewHeight / 2);
                        } else {
        ...
        setOnTouchListener(new OnTouchListener() { // from class: net.newsoftwares.hidepicturesvideos.photo.TouchImageView.2
    ...
    private float getImageWidth() {
        return this.oldMeasuredWidth * this.saveScale;
    }

    private float getImageHeight() {
        return this.oldMeasuredHeight * this.saveScale;
    }
